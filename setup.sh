...
echo "    - Shelfarr:        http://localhost:5056"
echo ""
echo "  Photos & Files:"
...
echo "  3. Install mobile apps (Jellyfin, Immich, Audiobookshelf, Nextcloud)"
echo "  4. (Optional) Add private indexers to Prowlarr at http://localhost:9696"
echo "  5. (Optional) Set up Kindle email — see docs/kindle-email-setup.md"
echo ""
if [[ "$SKIP_BUTLER" == "false" ]]; then
