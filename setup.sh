...
echo "  ✓ Prowlarr connected to Radarr, Sonarr, Readarr"
...
echo ""
echo "  1. Prowlarr: Add indexers at http://localhost:9696"
echo "  2. Immich: Create account at http://localhost:2283"
echo "  3. Home Assistant: Create account at http://localhost:8123"
echo "  4. Calibre-Web: Change default password (admin/admin123)"
echo "  5. Install mobile apps (Jellyfin, Immich, Audiobookshelf, Nextcloud)"
echo ""
if [[ "$SKIP_NANOBOT" == "false" ]]; then
