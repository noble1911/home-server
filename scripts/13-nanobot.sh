...
if [ ! -f .env ]; then
    ...
    if [[ -f "$CREDENTIALS_FILE" ]]; then
        ...
        [[ -n "$RADARR_API_KEY" ]] && sed_inplace "s|^RADARR_API_KEY=.*|RADARR_API_KEY=${RADARR_API_KEY}|" .env
        [[ -n "$SONARR_API_KEY" ]] && sed_inplace "s|^SONARR_API_KEY=.*|SONARR_API_KEY=${SONARR_API_KEY}|" .env
        [[ -n "$READARR_API_KEY" ]] && sed_inplace "s|^READARR_API_KEY=.*|READARR_API_KEY=${READARR_API_KEY}|" .env
        [[ -n "$PROWLARR_API_KEY" ]] && sed_inplace "s|^PROWLARR_API_KEY=.*|PROWLARR_API_KEY=${PROWLARR_API_KEY}|" .env
        [[ -n "$JELLYFIN_API_KEY" ]] && sed_inplace "s|^JELLYFIN_API_KEY=.*|JELLYFIN_API_KEY=${JELLYFIN_API_KEY}|" .env
